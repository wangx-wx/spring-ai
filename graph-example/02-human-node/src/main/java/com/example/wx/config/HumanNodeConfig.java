...
import com.example.wx.dispatcher.HumanFeedbackDispatcher;
import com.example.wx.node.ExpanderNode;
import com.example.wx.node.HumanFeedbackNode;
import com.example.wx.node.TranslateNode;
 ...
 * @author wangxiang
 * @description
 * @create 2025/9/27 21:43
 */
@Configuration
public class HumanNodeConfig {

    private static final Logger logger = LoggerFactory.getLogger(HumanNodeConfig.class);
