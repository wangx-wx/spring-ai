...
import com.example.wx.model.Constant;
...
public class ReaderController {
    ...
    public List<Document> readPdfParagraph() {
        ...
        // ParagraphPdfDocumentReader paragraphPdfDocumentReader = new ParagraphPdfDocumentReader(resource, PdfDocumentReaderConfig.builder()
        //         .withPageTopMargin(0)
    ...
    public List<Document> readMarkdown() {
        ...
        MarkdownDocumentReaderConfig config = MarkdownDocumentReaderConfig.builder()
                ...
                .build();
        MarkdownDocumentReader markdownDocumentReader = new MarkdownDocumentReader(Constant.MARKDOWN_FILE_PATH, config);
